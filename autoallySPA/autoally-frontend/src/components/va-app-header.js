...
customElements.define('va-app-header', class AppHeader extends LitElement {
  ...
  render(){    
    ...
    <header class="app-header">
      ...
      <a href="/newService" @click="${anchorRoute}">Add Service</a>  
      ` : ``}
    ...
    <sl-drawer class="app-side-menu" placement="left">
      ...
      <nav class="app-side-menu-items">
        ...
        ${this.user.accessLevel == 2 ?html`
          <a href="/newService" @click="${this.menuClick}">Add Service</a>  
        ` : ``}
        <a href="/technicians" @click="${this.menuClick}">Find A Technician</a>
        
        <a href="/services" @click="${this.menuClick}">Find A Service</a>
        <a href="/favouriteServices" @click="${this.menuClick}">Favourites</a>
