...
class GuideView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Guide\" user=\"", "\"></va-app-header>\n\n      <div class=\"page-graphic\">\n        <img src=\"", "/images/dark-van-bg.png\" alt=\"White van parked.\" />\n      </div>\n        \n      <div class=\"page-content calign\">        \n        <h3 class=\"brand-color-light\">Welcome ", "!</h3>\n        <p>This is a quick tour to teach you the basics of using AutoAlly ...</p>\n        \n        <div class=\"guide-step\">\n          <h4>Select a category</h4>\n          <img src=\"", "/images/categories.png\" alt=\"Mechanical icon, Electrical icon, Detailing icon, Windscreen icon, Paint & Panel icon, 4x4 icon, Restoration icon, Emergency icon.\" />\n        </div>\n        \n        <div class=\"guide-step\">\n          <h4>Find a local service</h4>\n          <img src=\"", "/images/more-info.png\" alt=\"Dialog boxes of local business\">\n        </div>\n        \n        <div class=\"guide-step\">\n          <h4>Save to favourites</h4>\n          <img src=\"", "/images/favourites.png\" alt=\"Dialog boxes of saved favourites.\">\n        </div>\n        \n        <sl-button type=\"primary\" @click=", ">Okay got it!</sl-button>\n        \n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _App.default.apiBase, _Auth.default.currentUser.firstName, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new GuideView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/favouriteService.js":[function(require,module,exports) {
"use strict";
...
class FavouriteServicesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n      h1 {\n        color: var(--sl-color-primary-100);\n      }\n    </style>\n      <va-app-header title=\"Favourite Services\" user=\"", "\"></va-app-header>\n      \n      ", "\n\n      ", "\n\n      <div class=\"page-content calign favourites-box\">        \n        <h1>Favourite Services</h1>\n        <div class=\"services-grid\">\n        ", "\n        </div>\n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.accessLevel == 1 ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      <div class=\"page-graphic\">\n      <img src=\"", "/images/dark-challenger-bg.png\" alt=\"\" />\n      </div>\n      "])), _App.default.apiBase) : "", _Auth.default.currentUser.accessLevel == 2 ? (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n      <div class=\"page-graphic\">\n        <img src=\"", "/images/dark-classic-bg.png\" alt=\"\" />\n      </div>\n      "])), _App.default.apiBase) : "", this.favServices == null ? (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n          <sl-spinner></sl-spinner>\n        "]))) : (0, _litHtml.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n          ", "\n        "])), this.favServices.map(service => (0, _litHtml.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n            <na-service class=\"service-card\"\n              id=\"", "\"\n              name=\"", "\"\n              category=\"", "\"\n              description=\"", "\"\n              user=\"", "\"\n              image=\"", "\">        \n            </na-service>\n\n          "])), service._id, service.name, service.category, service.description, JSON.stringify(service.user), service.image))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new FavouriteServicesView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/references.js":[function(require,module,exports) {
"use strict";
...
class ServicesView {
  ...
  render() {
    const services = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n      .filter-menu{\n        display: flex;\n        align-items: centre;\n      }\n\n      .filter-btn {\n        margin-right: 1em;\n        object-fit: contain;\n      }\n      .filter-clr {\n        margin-left: 10em;\n      }\n      </style>\n      <va-app-header title=\"Services\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-graphic\">\n          <img src=\"", "/images/dark-ferrari-bg.png\" alt=\"Classic Ferrari parked in shadow.\" />\n      </div>\n\n      <div class=\"page-content favourites-box\">  \n        <div class=\"calign\"> \n          <sl-button class='filter-btn' size='small' data-field= 'location' data-match='0-5' @click=", ">Under 5km</sl-button>\n          <sl-button class='filter-btn' size='small' data-field= 'location' data-match='0-10' @click=", ">Under 10km</sl-button>\n          <sl-button class='filter-btn' size='small' data-field= 'location' data-match='0-25' @click=", ">Under 25km</sl-button>\n          <sl-button class='filter-btn' size='small' data-field= 'location' data-match='0-5000' @click=", ">Over 25km</sl-button>\n          <sl-tooltip content=\"Display all available services\" style=\"--sl-tooltip-arrow-size: 0;\" placement=\"bottom\">    \n            <sl-button class='filter-clr' size='small' @click=", ">All Services</sl-button>\n          </sl-tooltip>\n        </div>\n        <div class=\"guide-step  welcome-box\">\n          <div class=\"filter-menu categories-grid\">\n            <div class=\"categories-card\">\n              <div class=\"filter-btn\">\n                <sl-tooltip content=\"Mechanical\" style=\"--sl-tooltip-arrow-size: 0;\" placement=\"top\">  \n                  <img type=\"button\" data-field='category' data-match='mechanical' @click=", " src=\"", "/images/mechanical.svg\" alt=\"Mechanical icon\"/>\n                </sl-tooltip>\n              </div>\n            </div>\n            <div class=\"categories-card\">\n              <div class=\"filter-btn\">\n                <sl-tooltip content=\"Electrical\" style=\"--sl-tooltip-arrow-size: 0;\" placement=\"top\">\n                  <img type=\"button\" data-field='category' data-match='electrical' @click=", " src=\"", "/images/electrical.svg\" alt=\"Electrical icon\"/>\n                </sl-tooltip>\n              </div>\n            </div>\n            <div class=\"categories-card\">\n              <div class=\"filter-btn\">\n                <sl-tooltip content=\"Detailing\" style=\"--sl-tooltip-arrow-size: 0;\" placement=\"top\">\n                  <img type=\"button\" data-field='category' data-match='detailing' @click=", " src=\"", "/images/detailing.svg\" alt=\"Detailing icon\"/>\n                </sl-tooltip>\n              </div>\n            </div>\n            <div class=\"categories-card\">\n              <div class=\"filter-btn\">\n                <sl-tooltip content=\"Windscreens\" style=\"--sl-tooltip-arrow-size: 0;\" placement=\"top\">\n                  <img type=\"button\" data-field='category' data-match='windscreen' @click=", " src=\"", "/images/windscreen.jpg\" alt=\"Windscreen icon\"/>\n                </sl-tooltip>  \n              </div>\n            </div>\n            <div class=\"categories-card\">\n              <div class=\"filter-btn\">\n                <sl-tooltip content=\"Paint & Panel\" style=\"--sl-tooltip-arrow-size: 0;\" placement=\"bottom\">\n                  <img type=\"button\" data-field='category' data-match='paint&panel' @click=", " src=\"", "/images/paintnpanel.svg\" alt=\"Spray painting icon\"/>\n                </sl-tooltip>\n              </div>\n            </div>\n            <div class=\"categories-card\">\n              <div class=\"filter-btn\">\n                <sl-tooltip content=\"4X4\" style=\"--sl-tooltip-arrow-size: 0;\" placement=\"bottom\">\n                  <img type=\"button\" data-field='category' data-match='4x4' @click=", " src=\"", "/images/4x4.png\" alt=\"4x4 icon\"/>\n                </sl-tooltip>\n              </div>\n            </div>\n            <div class=\"categories-card\">\n              <div class=\"filter-btn\">\n                <sl-tooltip content=\"Restoration\" style=\"--sl-tooltip-arrow-size: 0;\" placement=\"bottom\">\n                  <img type=\"button\" data-field='category' data-match='restoration' @click=", " src=\"", "/images/restoration.png\" alt=\"Restoration icon\"/>\n                </sl-tooltip>\n              </div>\n            </div>\n            <div class=\"categories-card\">\n              <div class=\"filter-btn\">\n                <sl-tooltip content=\"Emergency\" style=\"--sl-tooltip-arrow-size: 0;\" placement=\"bottom\">\n                  <img type=\"button\" data-field='category' data-match='emergency' @click=", " src=\"", "/images/emergency.jpg\" alt=\"Emergency icon\"/>\n                </sl-tooltip>\n              </div>\n            </div>\n            \n            \n          </div>\n          \n          \n        </div>\n        <div class=\"services-grid\" id=\"services-grid\">\n          ", "\n        </div>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _App.default.apiBase, this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.handleFilterBtn.bind(this), _App.default.apiBase, this.handleFilterBtn.bind(this), _App.default.apiBase, this.handleFilterBtn.bind(this), _App.default.apiBase, this.handleFilterBtn.bind(this), _App.default.apiBase, this.handleFilterBtn.bind(this), _App.default.apiBase, this.handleFilterBtn.bind(this), _App.default.apiBase, this.handleFilterBtn.bind(this), _App.default.apiBase, this.handleFilterBtn.bind(this), _App.default.apiBase, this.services == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          \n          "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n          ", "\n          "])), this.services.map(service => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n            <na-service class= \"service-card\" \n              id=", "\n              name=", " \n              category=", " \n              description=", " \n              user=", " \n              image=", "\n            </na-service>\n            "])), service._id, service.name, service.category, service.description, JSON.stringify(service.user), service.image))));
...
var _references = _interopRequireDefault(require("./views/pages/references"));
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/favouriteService":"views/pages/favouriteService.js","./views/pages/references":"views/pages/references.js","./views/pages/services":"views/pages/services.js","./views/pages/newService":"views/pages/newService.js"}],"App.js":[function(require,module,exports) {
"use strict";
