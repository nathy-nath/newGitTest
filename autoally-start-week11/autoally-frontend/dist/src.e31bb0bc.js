...
class ProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Profile\" user=\"", "\"></va-app-header>\n      \n      ", "\n\n      ", "\n      \n      <div class=\"page-content calign box guide-step\">   \n        ", "\n        <h2>", " ", "</h2>\n        <p>", "</p>\n        \n        <p>Updated: ", "</p>\n        \n        ", "\n\n        ", "\n        \n\n        <sl-button @click=", ">Edit Profile</sl-button>\n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.accessLevel == 1 ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      <div class=\"page-graphic\">\n      <img src=\"", "/images/dark-challenger-bg.png\" alt=\"\" />\n      </div>\n      "])), _App.default.apiBase) : "", _Auth.default.currentUser.accessLevel == 2 ? (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n      <div class=\"page-graphic\">\n        <img src=\"", "/images/dark-classic-bg.png\" alt=\"\" />\n      </div>\n      "])), _App.default.apiBase) : "", _Auth.default.currentUser && _Auth.default.currentUser.avatar ? (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n          <sl-avatar style=\"--size: 200px; margin-bottom: 1em;\" image=", "></sl-avatar>\n        "])), _Auth.default.currentUser && _Auth.default.currentUser.avatar ? "".concat(_App.default.apiBase, "/images/").concat(_Auth.default.currentUser.avatar) : '') : (0, _litHtml.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n        <sl-avatar style=\"--size: 200px; margin-bottom: 1em;\"></sl-avatar>\n        "]))), _Auth.default.currentUser.firstName, _Auth.default.currentUser.lastName, _Auth.default.currentUser.email, (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a'), _Auth.default.currentUser.bio ? (0, _litHtml.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n          <h3>Bio</h3>\n          <p>", "</p>\n        "])), _Auth.default.currentUser.bio) : (0, _litHtml.html)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral([""]))), _Auth.default.currentUser.vehicle ? (0, _litHtml.html)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n          <h3>Vehicle</h3>\n          <p>", "</p>\n        "])), _Auth.default.currentUser.vehicle) : (0, _litHtml.html)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral([""]))), () => (0, _Router.gotoRoute)('/editProfile'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Edit Profile\" user=", "></va-app-header>\n      \n      ", "\n\n      ", "\n      \n      <div class=\"page-content\">        \n        ", "\n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.accessLevel == 1 ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      <div class=\"page-graphic\">\n      <img src=\"", "/images/dark-challenger-bg.png\" alt=\"\" />\n      </div>\n      "])), _App.default.apiBase) : "", _Auth.default.currentUser.accessLevel == 2 ? (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n      <div class=\"page-graphic\">\n        <img src=\"", "/images/dark-classic-bg.png\" alt=\"\" />\n      </div>\n      "])), _App.default.apiBase) : "", this.user == null ? (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n          <sl-spinner></sl-spinner>\n        "]))) : (0, _litHtml.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n\n\n\n          <sl-form class=\"page-form guide-step box\" @sl-submit=", ">\n            <p>Updated: ", "</p>\n            <div class=\"input-group\">\n              <sl-input type=\"text\" name=\"firstName\" value=\"", "\" placeholder=\"First Name\"></sl-input>\n            </div>\n            <div class=\"input-group\">\n              <sl-input type=\"text\" name=\"lastName\" value=\"", "\" placeholder=\"Last Name\"></sl-input>\n            </div>\n            <div class=\"input-group\">\n              <sl-input type=\"text\" name=\"email\" value=\"", "\" placeholder=\"Email Address\"></sl-input>\n            </div> \n            <div class=\"input-group\">\n              <sl-textarea name=\"bio\" rows='2' value=\"", "\" placeholder=\"About me...\"></sl-textarea>\n            </div> \n            \n\n            ", "\n\n            \n            ", "\n            \n            <div class=\"input-group\">\n              <label>Avatar</label><br>          \n              ", "\n            </div>\n            <sl-button type=\"primary\" class=\"submit-btn\" submit>Update Profile</sl-button>\n          </sl-form>\n        "])), this.updateProfileSubmitHandler.bind(this), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a'), this.user.firstName, this.user.lastName, this.user.email, this.user.bio || "", this.user.accessLevel == 2 ? (0, _litHtml.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["     \n            <div class=\"input-group\">\n              <sl-input name=\"business\" value=\"", "\" placeholder=\"Business Name\" required></sl-input>\n            </div>\n            <div class=\"input-group\">\n              <sl-input name=\"phone\" value=\"", "\" placeholder=\"Phone\"></sl-input>\n            </div>\n            <div class=\"input-group\">\n              <sl-input name=\"address\" value=\"", "\" placeholder=\"Address\"></sl-input>\n            </div>\n            <div class=\"input-group\">\n              <sl-textarea name=\"about\" rows='10' value=\"", "\" placeholder=\"About us\"></sl-textarea>\n            </div>\n            \n            "])), this.user.business || "", this.user.phone || "", this.user.address || "", this.user.about || "") : "", this.user.accessLevel == 1 ? (0, _litHtml.html)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral([" \n            <div class=\"input-group\">\n              <sl-input name=\"vehicle\" value=\"", "\" placeholder=\"Vehicle\"></sl-input>\n            </div> \n\n            "])), this.user.vehicle || "") : "", this.user.avatar ? (0, _litHtml.html)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n                <sl-avatar image=\"", "/images/", "\"></sl-avatar>\n                <input type=\"file\" name=\"avatar\" />\n              "])), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n                <input type=\"file\" name=\"avatar\" />\n              "])))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
...
class GuideView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Guide\" user=\"", "\"></va-app-header>\n\n      <div class=\"page-graphic\">\n        <img src=\"", "/images/dark-van-bg.png\" alt=\"White van parked.\" />\n      </div>\n        \n      <div class=\"page-content calign\">        \n        <h3 class=\"brand-color-light\">Welcome ", "!</h3>\n        <p>This is a quick tour to teach you the basics of using AutoAlly ...</p>\n        \n        <div class=\"guide-step\">\n          <h4>Select a category</h4>\n          <img src=\"", "/images/Categories.png\" alt=\"Mechanical icon, Electrical icon, Detailing icon, Windscreen icon, Paint & Panel icon, 4x4 icon, Restoration icon, Emergency icon.\" />\n        </div>\n        \n        <div class=\"guide-step\">\n          <h4>Find a local service</h4>\n          <img src=\"", "/images/service-dialog.png\" alt=\"Dialog boxes of local business\">\n        </div>\n        \n        <div class=\"guide-step\">\n          <h4>Save to favourites</h4>\n          <img src=\"https://plchldr.co/i/500x300?&bg=dddddd&fc=666666&text=IMAGE\">\n        </div>\n        \n        <sl-button type=\"primary\" @click=", ">Okay got it!</sl-button>\n        \n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _App.default.apiBase, _Auth.default.currentUser.firstName, _App.default.apiBase, _App.default.apiBase, () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new GuideView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/hairdressers.js":[function(require,module,exports) {
"use strict";
...
var _default = new HairdressersView();
exports.default = _default;
...
class HaircutsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Haircuts\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        \n      <div class=\"haircuts-grid\">\n        ", "\n      </div>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), this.haircuts == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        <sl-spinner></sl-spinner>\n        "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        ", "\n        "])), this.haircuts.map(haircut => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        <va-haircut class= \"haircut-card\"\n            name=", " \n            description=", " \n            price=", " \n            user=", " \n            image=", "\n            gender=", " \n            length=", "\n            <p>This is inside the slot.</p>\n          </va-haircut>\n        "])), haircut.name, haircut.description, haircut.price, JSON.stringify(haircut.user), haircut.image, haircut.gender, haircut.length))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new HaircutsView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../HaircutAPI":"HaircutAPI.js","../../Toast":"Toast.js"}],"views/pages/favouriteService.js":[function(require,module,exports) {
"use strict";
...
class FavouriteServicesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Favourite Services\" user=\"", "\"></va-app-header>\n      <div class=\"page-graphic\">\n        <img src=\"", "/images/dark-van-bg.png\" alt=\"White van parked.\" />\n      </div>\n      <div class=\"page-content\">        \n        <h1>Favourite Services</h1>\n        <div class=\"services-grid\">\n        ", "\n        </div>\n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _App.default.apiBase, this.favServices == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <sl-spinner></sl-spinner>\n        "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n          ", "\n        "])), this.favServices.map(service => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n            <na-service class=\"service-card\"\n              id=\"", "\"\n              name=\"", "\"\n              category=\"", "\"\n              description=\"", "\"\n              user=\"", "\"\n              image=\"", "\">        \n            </na-service>\n\n          "])), service._id, service.name, service.category, service.description, JSON.stringify(service.user), service.image))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new FavouriteServicesView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"CategoryAPI.js":[function(require,module,exports) {
"use strict";
...
class CategoryAPI {
  ...
  async getCategories() {
    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/category"), {
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      }
    });
...
var _default = new CategoryAPI();
exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/categories.js":[function(require,module,exports) {
"use strict";
...
var _Auth = _interopRequireDefault(require("../../Auth"));
var _Utils = _interopRequireDefault(require("../../Utils"));
var _CategoryAPI = _interopRequireDefault(require("../../CategoryAPI"));
var _Toast = _interopRequireDefault(require("../../Toast"));
var _templateObject, _templateObject2, _templateObject3, _templateObject4;
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
class CategoriesView {
  ...
  async getCategories() {
    try {
      this.categories = await _CategoryAPI.default.getCategories();
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      \n      <va-app-header title=\"Categories\" user=\"", "\"></va-app-header>\n      <div class=\"page-graphic\">\n          <img src=\"", "/images/dark-carpark-bg.png\" alt=\"Circular parking structure.\" />\n      </div>\n      <div class=\"page-content\">        \n        \n        \n        <div class=\"categories-grid\">\n          ", "\n        \n        </div>  \n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _App.default.apiBase, this.categories == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <sl-spinner></sl-spinner>\n          "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n          ", "\n          "])), this.categories.map(category => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n          \n          <na-category class= \"categories-card\"\n            name=", " \n            description=", "\n            user=", " \n            image=", "\n          </na-category>\n          "])), category.name, category.description, JSON.stringify(category.user), category.image))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = new CategoriesView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../CategoryAPI":"CategoryAPI.js","../../Toast":"Toast.js"}],"views/pages/newHaircut.js":[function(require,module,exports) {
"use strict";
...
class newHaircutView {
  ...
  async newHaircutSubmitHandler(e) {
    ...
    try {
      ...
      _Toast.default.show('Haircut added!');
      submitBtn.removeAttribute('loading');
      // reset form
...
class ServicesView {
  ...
  render() {
    const services = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Services\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-graphic\">\n          <img src=\"", "/images/dark-ferrari-bg.png\" alt=\"Circular parking structure.\" />\n      </div>\n\n      <div class=\"page-content\">        \n        <div class=\"services-grid\">\n          ", "\n        </div>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _App.default.apiBase, this.services == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <sl-spinner></sl-spinner>\n          "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n          ", "\n          "])), this.services.map(service => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n            <na-service class= \"service-card\"\n            \n              id=", "\n\n              name=", " \n              category=", " \n              description=", " \n              user=", " \n              image=", "\n            </na-service>\n            "])), service._id, service.name, service.category, service.description, JSON.stringify(service.user), service.image))));
    (0, _litHtml.render)(services, _App.default.rootEl);
  }
}
var _default = new ServicesView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../ServiceAPI":"ServiceAPI.js","../../Toast":"Toast.js"}],"views/pages/newService.js":[function(require,module,exports) {
"use strict";
...
class DetailingView {
  ...
  render() {
    const detailing = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Detailing\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Detailing</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(detailing, _App.default.rootEl);
  }
}
var _default = new DetailingView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/mechanical.js":[function(require,module,exports) {
"use strict";
...
class MechanicalView {
  ...
  render() {
    const mechanical = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Mechanical\" user=\"", "\"></va-app-header>\n      \n      <div class=\"page-graphic\">\n          <img src=\"", "/images/dark-classic-bg.png\" alt=\"Circular parking structure.\" />\n      </div>\n      \n      <div class=\"page-content\">        \n        <div class=\"services-grid\">\n          ", "\n        </div>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _App.default.apiBase, this.services == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <sl-spinner></sl-spinner>\n          "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n          ", " \n          "])), this.services.map(service => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n            <na-service class= \"service-card\"\n              id=", "\n              name=", " \n              category=", " \n              description=", " \n              user=", " \n              image=", "\n            </na-service>\n            "])), service._id, service.name, service.category, service.description, JSON.stringify(service.user), service.image))));
    (0, _litHtml.render)(mechanical, _App.default.rootEl);
  }
}
var _default = new MechanicalView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../ServiceAPI":"ServiceAPI.js"}],"views/pages/4x4.js":[function(require,module,exports) {
"use strict";
...
class FourXView {
  ...
  render() {
    const fourX = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Profile\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>4x4</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(fourX, _App.default.rootEl);
  }
}
var _default = new FourXView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/restoration.js":[function(require,module,exports) {
"use strict";
...
class RestorationView {
  ...
  render() {
    const restoration = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Restoration\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Restoration</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(restoration, _App.default.rootEl);
  }
}
var _default = new RestorationView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/windscreen.js":[function(require,module,exports) {
"use strict";
...
class WindscreenView {
  ...
  render() {
    const windscreen = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Windscreen\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Windscreen</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(windscreen, _App.default.rootEl);
  }
}
var _default = new WindscreenView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/electrical.js":[function(require,module,exports) {
"use strict";
...
class ElectricalView {
  ...
  render() {
    const electrical = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Electrical\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Electrical</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(electrical, _App.default.rootEl);
  }
}
var _default = new ElectricalView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/emergency.js":[function(require,module,exports) {
"use strict";
...
class EmergencyView {
  ...
  render() {
    const emergency = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Emergency\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Emergency</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(emergency, _App.default.rootEl);
  }
}
var _default = new EmergencyView();
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/paint-panel.js":[function(require,module,exports) {
"use strict";
...
class PaintPanelView {
  ...
  render() {
    const paintPanel = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Paint & Panel\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <h1>Paint & Panel</h1>\n        <p>Page content ...</p>\n        \n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(paintPanel, _App.default.rootEl);
  }
}
var _default = new PaintPanelView();
exports.default = _default;
...
var _favouriteService = _interopRequireDefault(require("./views/pages/favouriteService"));
var _categories = _interopRequireDefault(require("./views/pages/categories"));
...
var _detailing = _interopRequireDefault(require("./views/pages/detailing"));
var _mechanical = _interopRequireDefault(require("./views/pages/mechanical"));
var _x = _interopRequireDefault(require("./views/pages/4x4"));
var _restoration = _interopRequireDefault(require("./views/pages/restoration"));
var _windscreen = _interopRequireDefault(require("./views/pages/windscreen"));
var _electrical = _interopRequireDefault(require("./views/pages/electrical"));
var _emergency = _interopRequireDefault(require("./views/pages/emergency"));
var _paintPanel = _interopRequireDefault(require("./views/pages/paint-panel"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
// import views
...
const routes = {
  ...
  '/favouriteServices': _favouriteService.default,
  '/categories': _categories.default,
  '/newHaircut': _newHaircut.default,
  '/newService': _newService.default,
  '/services': _services.default,
  '/categories/detailing': _detailing.default,
  '/categories/mechanical': _mechanical.default,
  '/categories/4x4': _x.default,
  '/categories/restoration': _restoration.default,
  '/categories/windscreen': _windscreen.default,
  '/categories/electrical': _electrical.default,
  '/categories/emergency': _emergency.default,
  '/categories/paint&panel': _paintPanel.default
};
class Router {
  constructor() {
    this.routes = routes;
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/test":"views/pages/test.js","./views/pages/guide":"views/pages/guide.js","./views/pages/hairdressers":"views/pages/hairdressers.js","./views/pages/haircuts":"views/pages/haircuts.js","./views/pages/favouriteService":"views/pages/favouriteService.js","./views/pages/categories":"views/pages/categories.js","./views/pages/newHaircut":"views/pages/newHaircut.js","./views/pages/services":"views/pages/services.js","./views/pages/newService":"views/pages/newService.js","./views/pages/detailing":"views/pages/detailing.js","./views/pages/mechanical":"views/pages/mechanical.js","./views/pages/4x4":"views/pages/4x4.js","./views/pages/restoration":"views/pages/restoration.js","./views/pages/windscreen":"views/pages/windscreen.js","./views/pages/electrical":"views/pages/electrical.js","./views/pages/emergency":"views/pages/emergency.js","./views/pages/paint-panel":"views/pages/paint-panel.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('na-category', class Category extends _litElement.LitElement {
  constructor() {
    super();
  }
  static get properties() {
  ...
  render() {
    ...
    return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    \n    <style>\n        .author {\n            font-size: 0.9em;\n            font-style: italic;\n            opacity: 0.8;\n        }\n    </style>\n   \n    <sl-card>\n        <img slot=\"image\" src=\"", "/images/", "\"/>\n        <h2>", "</h2>\n        \n        <sl-button class=\"anim-in\" @click=", ">Start</sl-button>\n        \n    </sl-card>\n\n  \n    "])), _App.default.apiBase, this.image, this.name, () => (0, _Router.gotoRoute)('/categories/' + page));
  }
});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js"}],"components/na-service.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
customElements.define('na-service', class Service extends _litElement.LitElement {
  constructor() {
    super();
  }
  static get properties() {
  ...
  moreInfoHandler() {
    ...
    const dialogContent = (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n        .wrap {\n        display: flex;\n        }\n        .image {\n        width: 50%;\n        }\n        .image img {\n        width: 100%;\n        }\n        .content {\n        padding-left: 1em;\n        }\n        h1 {\n          color: #1d3557;\n        }\n        h3 {\n            font-size: 1.5em;\n            color: var(--brand-color);\n            text-transform: uppercase;\n            font-weight: bold;\n        }\n        \n    </style>\n    <div class=\"wrap\">\n      \n        <div class=\"image\">\n            <img src=\"", "/images/", "\" alt=\"", "\" />\n        </div>\n        <div class=\"content\">\n          \n          <h1>", "</h1>\n          <h3>", "</h3>\n          <p>", "</p>\n\n          <sl-button @click=", ">\n              <sl-icon slot=\"prefix\" name=\"heart-fill\"></sl-icon>\n              Add to Favourites\n          </sl-button>\n        </div>\n    </div>\n  "])), _App.default.apiBase, this.image, this.name, this.name, this.category, this.description, this.addFavHandler.bind(this));
    (0, _litHtml.render)(dialogContent, dialogEl);
  ...
  async addFavHandler() {
    try {
      await _UserAPI.default.addFavService(this.id);
  ...
  render() {
    return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    <style>\n        .author {\n            font-size: 0.9em;\n            font-style: italic;\n            opacity: 0.8;\n        }\n        h1 {\n          color: #1d3557;\n        }\n        h3 {\n            font-size: 1.5em;\n            color: var(--brand-color);\n            text-transform: uppercase;\n            font-weight: bold;\n        }\n        p {\n          width: 10em;\n        }\n    </style>\n\n    <sl-card class=\"thin-tab\">\n      <h3>", "</h3>\n      <img style=\"width: 100%; object-fit: contain\" slot=\"image\" src=\"", "/images/", "\"/>     \n      <h1>", "</h1>   \n      <p>", "...</p>\n      <p class=\"author\">By ", " ", "</p>\n      <sl-button @click=", ">More info</sl-button>\n      <sl-icon-button name=\"heart-fill\" label=\"Add to Favourites\" \n      @click=", "></sl-icon-button>\n    </sl-card>\n\n  \n    "])), this.category, _App.default.apiBase, this.image, this.name, this.description.slice(0, 30), this.user.firstName, this.user.lastName, this.moreInfoHandler.bind(this), this.addFavHandler.bind(this));
  }
});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js","../UserAPI":"UserAPI.js","./../Toast":"Toast.js"}],"components/na-mechanical.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
customElements.define('na-mechanical', class Mechanical extends _litElement.LitElement {
  constructor() {
    super();
  }
  static get properties() {
  ...
  render() {
    return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    <style>\n        .author {\n            font-size: 0.9em;\n            font-style: italic;\n            opacity: 0.8;\n        }\n        h1 {\n          color: var(--brand-color);\n          text-transform: uppercase;\n          font-weight: bold;\n        }\n        p {\n          width: 10em;\n        }\n    </style>\n\n    <sl-card>\n      \n      <img style=\"width: 100%; object-fit: cover\" slot=\"image\" src=\"", "/images/", "\"/>\n      \n      <h2>", "</h2>\n      <h1>", "</h1>\n      <p>", "...</p>\n      <p class=\"author\">By ", " ", "</p>\n      <sl-button @click=", ">More info</sl-button>\n      <sl-icon-button name=\"heart-fill\" label=\"Add to Favourites\" \n      @click=", "></sl-icon-button>\n    </sl-card>\n\n  \n    "])), _App.default.apiBase, this.image, this.name, this.category, this.description.slice(0, 30), this.user.firstName, this.user.lastName, this.moreInfoHandler.bind(this), this.addFavHandler.bind(this));
  }
});
...
require("./components/na-category");
require("./components/na-service");
require("./components/na-mechanical");
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/na-category":"components/na-category.js","./components/na-service":"components/na-service.js","./components/na-mechanical":"components/na-mechanical.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
